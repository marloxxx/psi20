...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">
            <a href="{{ route('backend.homestays.index') }}" class="text-white">Settings</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">A first name is required and recommended to be
                                        unique.
                                    </div>
                                    <!--end::Description-->
                                </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">A last name is required and recommended to be
                                        unique.
                                    </div>
                                    <!--end::Description-->
                                </div>
