...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">All Events</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Add Facility-->
                <a href="{{ route('backend.events.create') }}" class="btn btn-primary" id="kt_toolbar_primary_button">
                    Add Event
                </a>
                <!--end::Add Facility-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#datatables').DataTable({
                serverSide: true,
                ajax: '{{ route('backend.events.index') }}',
                columns: [{
                        data: 'checkbox',
                        name: 'checkbox',
                        orderable: false,
