...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">All Facilities</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Add Facility-->
                <a href="{{ route('backend.facilities.create') }}" class="btn btn-primary" id="kt_toolbar_primary_button">
                    Add Facility
                </a>
                <!--end::Add Facility-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#datatables').DataTable({
                serverSide: true,
                ajax: '{{ route('backend.facilities.index') }}',
                columns: [{
                        data: 'checkbox',
                        name: 'checkbox',
                        orderable: false,
