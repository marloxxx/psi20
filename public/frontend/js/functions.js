!(function (e) {
    ...
    [].slice
        .call(document.querySelectorAll('[class="tooltip-1"]'))
        .map(function (e) {
            return new bootstrap.Tooltip(e);
        });
    e(".accordion_styled").on(
        ...
        e(".btn_map").on("click", function () {
            var o = e(this);
            o.text() == o.data("text-swap")
                ? o.text(o.data("text-original"))
                : o.text(o.data("text-swap"));
        }),
        new WOW().init(),
        e(function () {
            e(".parallax-window").parallax({ zIndex: 1 }),
                ...
                e("ul#top_tools li .dropdown").hover(
                    function () {
                        e(this)
                            .find(".dropdown-menu")
                            .stop(!0, !0)
            ...
            for (
                var o = document.querySelectorAll(".cmn-toggle-switch"),
                a = o.length - 1;
                a >= 0;
                a--
            ) {
        ...
        e("#map_filter ul li a").on("click", function () {
            e("#map_filter ul li a.active").removeClass("active"),
                e(this).addClass("active");
        }),
        // e(function () {
        ...
        e(".search-overlay-menu-btn").on("click", function (o) {
            e("body").addClass("has-fullscreen-modal"),
        ...
        e(".search-overlay-close").on("click", function (o) {
            e(".search-overlay-menu").removeClass("open"),
                e("body").removeClass("has-fullscreen-modal");
        }),
        e(
            ".search-overlay-menu, .search-overlay-menu .search-overlay-close"
        ).on("click keyup", function (o) {
            (o.target == this ||
                "search-overlay-close" == o.target.className ||
                27 == o.keyCode) &&
        ...
        e("#carousel-home .owl-carousel").on(
